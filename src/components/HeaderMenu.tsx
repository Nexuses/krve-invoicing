...
export const HeaderMenu = () => {
  ...
  // @return
  return <header className={cn('fixed top-0 left-0 right-0 z-50 transition-all duration-300 px-6 lg:px-12', scrolled ? 'bg-white/95 backdrop-blur-md shadow-sm py-3' : 'bg-transparent py-6')}>
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        {/* Logo Section */}
        <div className="flex-shrink-0">
          <a href="#" className="flex items-center">
            <img src="https://i0.wp.com/krvauditing.co/wp-content/uploads/2024/06/krv-logo-color.png?fit=493%2C245&ssl=1" alt="KRV Auditing" className="h-10 md:h-12 w-auto transition-transform hover:scale-105" />
          </a>
        </div>
